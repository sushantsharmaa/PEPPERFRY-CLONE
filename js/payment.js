...
function to_hide(){
    // let a1 = document.getElementById("shipping-details")
    //     a1.style.display = "none"
    // let a2 = document.getElementById("plus-minus2")
    //     a2.innerHTML = `<span class="material-icons-outlined">   add </span>`
...
function change(id){
    ...
    if(id === 'atmDiv'){
        ...
        // let tem = document.querySelector("#atmDiv:after");
        // console.log('tem:', tem)
        // selected_div.after.display = "block";
        // console.log('selected_div.after:', selected_div.after)
